 ...
 * `plantMark` helper, today in `app/admin/page.tsx` and moving to
 * `app/admin/inbox/page.tsx` in this slice's route shuffle. Filtering follows
 * the same rule from the other side: an absent suggestion is not evidence of
 ...
 * a switcher goes on to render from the result — that stays true even after
 * this file's callers change.
 *
