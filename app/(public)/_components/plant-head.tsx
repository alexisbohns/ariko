...
import { PLANT_ROLE_ICONS, ZapIcon, ZapOffIcon } from "@/components/public-icons";
 ...
 * — and so is the knight. The role glyph is no longer a crown for everyone:
 * `PLANT_ROLE_ICONS` gives owner and co-owner the crown, lead the knight and
 * contributor the pawn, which is the same split the admin garden and the admin
 * hero draw, from the map they declare on their own side of the lucide line.
 *
