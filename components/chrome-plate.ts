 ...
 * cluster (`app/admin/_components/admin-chrome.tsx`), the plant page's Inside
 * rail (`app/admin/_components/plant-inside.tsx`), and the public zone's
 * mark/nav and language clusters (`app/(public)/_components/public-chrome.tsx`).
 *
