...
export function Prose({
  ...
  return (
    ...
    // face at medium and tight, matching every other heading in both zones (the
    // plant head's h1 is the one exception — it wears Profane).
    //
    // One of the surfaces this renders on is in the ADMIN: /admin/sprout/[slug]
    // renders <Prose> too. That is intended rather than tolerated — the admin's
    // is a PREVIEW of the public render, and a preview set two points smaller
